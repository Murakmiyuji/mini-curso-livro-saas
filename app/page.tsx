  ...
  return (
    <main>
      <section className="container mx-auto text-center pb-20 px-2 md:px-0">
        <nav className="flex justify-between items-center pv-4">
        ...
        <p className="text-gray-500 mt-4 md:text-xl text-sm max-w-3xl mx-auto">
        ...
        <form className="mt-10 md:mt-16">
          <div className="flex justify-center gap-2">
            <Input
              className=" max-w-sm botder-gray-300"
              type="email"
